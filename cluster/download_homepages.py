...
""" Downloads homepages of stock tickers from yahoo finance.
    ...
    NOTE: This script doesn't handle invalid homepages (ie, when the ticker
    is not available on yahoo), in which case an error page will be downloaded.
    Downstream scripts must handle this.
"""
